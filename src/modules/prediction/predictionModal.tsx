  ...
  return (
    <>
      <div
        ...
        className={`${
          isOpen ? 'open' : 'hidden'
        } hs-overlay hs-overlay-open:opacity-100 hs-overlay-open:duration-500 w-full h-full fixed top-0 start-0 z-[60] opacity-0 overflow-x-hidden transition-all overflow-y-auto pointer-events-none`}
      >
